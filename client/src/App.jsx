    ...
    <div className="w-full h-screen">
      ...
      <div className="flex flex-col items-center min-h-screen px-4 md:px-6 space-y-6 md:space-y-8 pt-20 md:pt-12   ">
        ...
        <section className="h-screen flex flex-col lg:flex-row w-full action-section gap-4 p-4">
          <div className="w-full lg:w-1/2 text-2xl font-bold h-1/2 lg:h-full flex justify-center items-center bg-[#B7E5CE] rounded-xl hover:-translate-y-2 duration-300">
            Start Coloring
          </div>
          <div className="w-full lg:w-1/2 text-2xl font-bold h-1/2 lg:h-full flex justify-center items-center bg-[#F0A8B7] rounded-xl hover:-translate-y-2 duration-300">
            Read Instructions
          </div>
        </section>
      </div>
