function ColouringPageText() {
  return (
    <div className="text-md lg:text-lg xl:text-xl font-semibold italic text-white mx-4 sm:mx-0 text-left">
      <p>
...
export default ColouringPageText;
